...
import { deleteItem } from "@/app/store/features/cart";
export const CartProducts = ({productchange,prodQuantity,Total,cartValue,productname,totalitems,originalprice,cartCounter,setCartCounter}:any) => {
...
{/* Checkout Button */}
{/* <button onClick={ resetCart } className="bg-orange py-4 rounded-xl text-white mb-2 font-bold">
Checkout
</button> */}
}
